...
return (
    <div className='pb-[95px] lg:px-[150px]'>
      ...
      <div className="lg:grid lg:grid-cols-2  md:grid md:grid-cols-2 pb-[58px] lg:pb-[40px] ">
        <div className="bg-mobile-zx7-speaker md:bg-tablet-zx7-speaker bg-cover lg:bg-desktop-zx7-speaker bg-no-repeat bg-center rounded-lg mx-5 md:mx-7 mb-5  md:h-full md:w-[40vw] lg:w-[25vw] lg:h-[300px] h-[400px]">
        </div>
        <div className=" py-6 px-5 lg:h-[300px] lg:pl-0">
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] font-bold tracking-wider">ZX7</h2>
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] mt-[-7px] font-bold tracking-wider">SPEAKER</h2>
          <p className="lg:text-[10px] lg:py-2 text-[#adabab] py-6">Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.</p>
          <p className='text-[22px] lg:text-[12px] font-bold pb-7 pt-2'>$ 3,500</p>
          <div className='flex gap-8'>
            <div className='flex justify-around items-center h-[50px] lg:h-[30px] text-lg lg:text-xs lg:w-[80px] bg-gray w-[140px]'>
              <button className='opacity-50 hover:text-brown' onClick={() => subFromCart(6)}>-</button>
              <span className='font-semibold'>{cartItems[6]}</span>
              <button className='opacity-50 hover:text-brown' onClick={() => addToCart(6)}>+</button>
            </div>
      ...
      <div className='px-5 md:px-7 md:grid md:grid-cols-2'>
        ...
        <div className='text-[20px] lg:text-xs lg:pl-[110px]'>
          ...
          <div className='flex items-center gap-6 pb-4'>
            <span className=' text-brown font-semibold'>1x</span>
            <span className='text-[#adabab]'>3.5mm 7.5m Audio Cable</span>
          </div>
          <div className='flex items-center gap-6 pb-4'>
            <span className=' text-brown font-semibold'>1x</span>
            <span className='text-[#adabab]'>7.5m Optical Cable</span>
          </div>
        </div>
      </div>
      <div className='md:grid md:pt-[55px] pt-[55px] lg:pt-0 md:grid-cols-2 '>
        <div className='bg-mobile-zx7-gallery-1 md:bg-tablet-zx7-gallery-1 lg:bg-desktop-zx7-gallery-1 bg-cover bg-center rounded-lg m-5 md:mb-0 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-zx7-gallery-2 md:row-start-2 md:bg-tablet-zx7-gallery-2 lg:bg-desktop-zx7-gallery-2 bg-cover bg-center rounded-lg m-5 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-zx7-gallery-3 md:row-span-2 md:h-[92%] lg:h-[90%]  md:bg-tablet-zx7-gallery-3 lg:bg-desktop-zx7-gallery-3 bg-cover bg-center rounded-lg m-5 md:ml-0 h-[400px]'></div>
      </div>
      <div className='my-[120px] lg:my-[70px] pb-3 md:grid md:grid-cols-3'>
        ...
        <div className='text-center mb-11'>
          ...
          <h2 className='py-4 font-bold text-[28px] lg:text-[18px] lg:py-0 tracking-wider'>ZX9 SPEAKER</h2>
