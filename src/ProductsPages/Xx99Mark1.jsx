  ...
  return (
    <div className='pb-[95px] lg:px-[150px]'>
      ...
      <div className="lg:grid lg:grid-cols-2  md:grid md:grid-cols-2 pb-[58px] lg:pb-[40px] ">
        <div className="bg-mobile-xx99markI md:bg-tablet-xx99markI bg-cover lg:bg-desktop-xx99markI bg-no-repeat bg-center rounded-lg mx-5 md:mx-7 mb-5  md:h-full md:w-[40vw] lg:w-[25vw] lg:h-[300px] h-[400px]">
        </div>
        <div className=" py-6 px-5 lg:h-[300px] lg:pl-0">
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] font-bold tracking-wider">XX99 MARK I</h2>
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] mt-[-7px] font-bold tracking-wider">HEADPHONES</h2>
          <p className="lg:text-[10px] lg:py-2 text-[#adabab] py-6">As the gold standard for headphones, the classic XX99 Mark I offers detailed and accurate audio reproduction for audiophiles, mixing engineers, and music aficionados alike in studios and on the go.</p>
          <p className='text-[22px] lg:text-[12px] font-bold pb-7 pt-2'>$ 1,750</p>
          <div className='flex gap-8'>
            <div className='flex justify-around items-center h-[50px] lg:h-[30px] text-lg lg:text-xs lg:w-[80px] bg-gray w-[140px]'>
              <button className='opacity-50 hover:text-brown' onClick={() => subFromCart(4)}>-</button>
              <span className='font-semibold'>{cartItems[4]}</span>
              <button className='opacity-50 hover:text-brown' onClick={() => addToCart(4)}>+</button>
            </div>
      ...
      <div className='md:grid md:pt-[55px] pt-[55px] lg:pt-0 md:grid-cols-2 '>
        <div className='bg-mobile-xx99markI-gallery-1 md:bg-tablet-xx99markI-gallery-1 lg:bg-desktop-xx99markI-gallery-1 bg-cover bg-center rounded-lg m-5 md:mb-0 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-xx99markI-gallery-2 md:row-start-2 md:bg-tablet-xx99markI-gallery-2 lg:bg-desktop-xx99markI-gallery-2 bg-cover bg-center rounded-lg m-5 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-xx99markI-gallery-3 md:row-span-2 md:h-[92%] lg:h-[90%]  md:bg-tablet-xx99markI-gallery-3 lg:bg-desktop-xx99markI-gallery-3 bg-cover bg-center rounded-lg m-5 md:ml-0 h-[400px]'></div>
      </div>
