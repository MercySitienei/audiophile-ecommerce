  ...
  return (
    <div className='pb-[95px] lg:px-[150px]'>
      ...
      <div className="lg:grid lg:grid-cols-2  md:grid md:grid-cols-2 pb-[58px] lg:pb-[40px] ">
        <div className="bg-mobile-xx99markII md:bg-tablet-xx99markII bg-cover lg:bg-desktop-xx99markII bg-no-repeat bg-center rounded-lg mx-5 md:mx-7 mb-5  md:h-full md:w-[40vw] lg:w-[25vw] lg:h-[300px] h-[400px]">
        </div>
        <div className=" py-6 px-5 lg:h-[300px] lg:pl-0">
          ...
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] font-bold tracking-wider">XX99 MARK II</h2>
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] mt-[-7px] font-bold tracking-wider">HEADPHONES</h2>
          <p className="lg:text-[10px] lg:py-2 text-[#adabab] py-6">The new XX99 Mark II headphones is the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound.</p>
          <p className='text-[22px] lg:text-[12px] font-bold pb-7 pt-2'>$ 2,999</p>
          <div className='flex gap-8'>
            <div className='flex justify-around items-center h-[50px] lg:h-[30px] text-lg lg:text-xs lg:w-[80px] bg-gray w-[140px]'>
              <button className='opacity-50 hover:text-brown' onClick={() => subFromCart(1)}>-</button>
              <span className='font-semibold'>{cartItems[1]}</span>
              <button className='opacity-50 hover:text-brown' onClick={() => addToCart(1)}>+</button>
            </div>
      ...
      <div className='px-5 md:px-7 md:grid md:grid-cols-2'>
        ...
        <p className='text-lg lg:text-xs md:col-span-2 lg:col-span-1 lg:row-start-2 text-[#adabab] pb-[60px] md:pb-[150px] lg:pb-[70px]'>Featuring a genuine leather head strap and premium earcups, these headphones deliver superior comfort for those who like to enjoy endless listening. It includes intuitive controls designed for any situation. Whether you’re taking a business call or just in your own personal space, the auto on/off and pause features ensure that you’ll never miss a beat. <br /> <br />
        ...
        <div className='text-[20px] lg:text-xs lg:pl-[110px]'>
          ...
          <div className='flex items-center gap-6 pb-4'>
            <span className=' text-brown font-semibold'>1x</span>
            <span className='text-[#adabab]'>Travel Bag</span>
          </div>
        </div>
      </div>
      <div className='md:grid md:pt-[55px] lg:pt-0 md:grid-cols-2 '>
        <div className='bg-mobile-xx99markII-gallery-1 md:bg-tablet-xx99markII-gallery-1 lg:bg-desktop-xx99markII-gallery-1 bg-cover bg-center rounded-lg m-5 md:mb-0 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-xx99markII-gallery-2 md:row-start-2 md:bg-tablet-xx99markII-gallery-2 lg:bg-desktop-xx99markII-gallery-2 bg-cover bg-center rounded-lg m-5 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-xx99markII-gallery-3 md:row-span-2 md:h-[92%] lg:h-[90%]  md:bg-tablet-xx99markII-gallery-3 lg:bg-desktop-xx99markII-gallery-3 bg-cover bg-center rounded-lg m-5 md:ml-0 h-[400px]'></div>
      </div>
