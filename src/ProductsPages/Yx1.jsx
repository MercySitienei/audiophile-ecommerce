  ...
  return (
    <div className='pb-[95px] lg:px-[150px]'>
      ...
      <div className="lg:grid lg:grid-cols-2 md:grid md:grid-cols-2 pb-[58px] lg:pb-[40px]">
        <div className="bg-mobile-yx1-earphones md:bg-tablet-yx1-earphones bg-cover lg:bg-desktop-yx1-earphones bg-no-repeat bg-center rounded-lg mx-5 md:mx-7 mb-5 md:h-full md:w-[40vw] lg:w-[25vw] lg:h-[300px] h-[400px]"></div>
        <div className="py-6 px-5 lg:h-[300px] lg:pl-0">
          ...
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] font-bold tracking-wider">YX1 WIRELESS</h2>
          <h2 className="text-[33px] md:text-[28px] lg:text-[18px] mt-[-7px] font-bold tracking-wider">EARPHONES</h2>
          <p className="lg:text-[10px] lg:py-2 text-[#adabab] py-6">Tailor your listening experience with bespoke dynamic drivers from the new YX1 Wireless Earphones. Enjoy incredible high-fidelity sound even in noisy environments with its active noise cancellation feature.</p>
          <p className='text-[22px] lg:text-[12px] font-bold pb-7 pt-2'>$ 599</p>
          <div className='flex gap-8'>
            <div className='flex justify-around items-center h-[50px] lg:h-[30px] text-lg lg:text-xs lg:w-[80px] bg-gray w-[140px]'>
              <button className='opacity-50 hover:text-brown' onClick={() => subFromCart(3)}>-</button>
              <span className='font-semibold'>{cartItems[3]}</span>
              <button className='opacity-50 hover:text-brown' onClick={() => addToCart(3)}>+</button>
            </div>
      ...
      <div className='px-5 md:px-7 md:grid md:grid-cols-2'>
        ...
        <div className='text-[20px] lg:text-xs lg:pl-[110px]'>
          <div className='flex items-center gap-6 pb-4'>
            ...
            <span className='text-[#adabab]'>Earphone Unit</span>
          </div>
          <div className='flex items-center gap-6 pb-4'>
            <span className='text-brown font-semibold'>6x</span>
            <span className='text-[#adabab]'>Multi-size Earplugs</span>
          </div>
          <div className='flex items-center gap-6 pb-4'>
          ...
          <div className='flex items-center gap-6 pb-4'>
            <span className='text-brown font-semibold'>1x</span>
            <span className='text-[#adabab]'>USB-C Charging Cable</span>
          </div>
          <div className='flex items-center gap-6 pb-4'>
            <span className='text-brown font-semibold'>1x</span>
            <span className='text-[#adabab]'>Travel Pouch</span>
          </div>
        </div>
      </div>
      <div className='md:grid md:pt-[55px] lg:pt-0 md:grid-cols-2'>
        <div className='bg-mobile-yx1-gallery-1 md:bg-tablet-yx1-gallery-1 lg:bg-desktop-yx1-gallery-1 bg-cover bg-center rounded-lg m-5 md:mb-0 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-yx1-gallery-2 md:row-start-2 md:bg-tablet-yx1-gallery-2 lg:bg-desktop-yx1-gallery-2 bg-cover bg-center rounded-lg m-5 lg:h-[150px] h-[220px]'></div>
        <div className='bg-mobile-yx1-gallery-3 md:row-span-2 md:h-[92%] lg:h-[90%] md:bg-tablet-yx1-gallery-3 lg:bg-desktop-yx1-gallery-3 bg-cover bg-center rounded-lg m-5 md:ml-0 h-[400px]'></div>
      </div>
      <div className='my-[120px] lg:my-[70px] pb-3 md:grid md:grid-cols-3'>
        ...
        <div className='text-center mb-11'>
          ...
          <button className='bg-brown hover:bg-light-brown text-white tracking-widest text-lg lg:text-sm px-10 my-6 lg:py-2 lg:px-6 py-4'>
            <Link to={'/xx99mark1'}>SEE PRODUCT</Link>
          </button>
        </div>
        <div className='text-center mb-11'>
          ...
          <h2 className='py-4 font-bold text-[28px] lg:text-[18px] lg:py-0 tracking-wider'>XX59</h2>
          <button className='bg-brown hover:bg-light-brown text-white tracking-widest text-lg lg:text-sm px-10 my-6 lg:py-2 lg:px-6 py-4'>
        ...
        <div className='text-center mb-11'>
          ...
          <button className='bg-brown hover:bg-light-brown text-white tracking-widest text-lg lg:text-sm px-10 my-6 lg:py-2 lg:px-6 py-4'>
            <Link to={'/zx9speaker'}>SEE PRODUCT</Link>
          </button>
        </div>
      </div>
      <Categories />
